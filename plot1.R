...
# @date: 08/06/2015
#
# @intent: The following R script perform an analysis of the variation of household energy
# usage over a two day period. In particular, this function will plot the histogram of
# the frequency of "Global Active Power".
# @side effects: Create a file "plot1.png" containing the histogram of "Global Active
# Power".
#
#######################################################################################
...
# now, data is prepared for analysis ...
# open PNG graphics device to plot histogram of global active power
png("plot1.png")
