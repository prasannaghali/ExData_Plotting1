...
# energy usage over a two day period. In particular, this function will plot Global
# Active Power across a time series between 1/2/2007 and 2/2/2007.
# @side effects: Create a file "plot2.png" containing the time series line plot of
# Global Active Power between 1/2/2007 and 2/2/2007.
#
#######################################################################################
